...
use wdk_sys::{
    ...
    PFN_WDF_INTERRUPT_DPC, PFN_WDF_INTERRUPT_ISR, PFN_WDF_IO_QUEUE_IO_DEVICE_CONTROL, ULONG,
    WDF_DRIVER_CONFIG, WDF_EXECUTION_LEVEL, WDF_FILEOBJECT_CLASS, WDF_FILEOBJECT_CONFIG,
    WDF_INTERRUPT_CONFIG, WDF_IO_QUEUE_CONFIG, WDF_OBJECT_ATTRIBUTES, WDF_PNPPOWER_EVENT_CALLBACKS,
    WDF_SYNCHRONIZATION_SCOPE, WDF_TRI_STATE,
};
