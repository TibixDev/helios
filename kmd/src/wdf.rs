...
use wdk_sys::{
    ...
    _WDF_SYNCHRONIZATION_SCOPE, _WDF_TRI_STATE, GUID, PCWDF_OBJECT_CONTEXT_TYPE_INFO,
    PFN_WDF_DEVICE_D0_ENTRY, PFN_WDF_DEVICE_D0_EXIT, PFN_WDF_DEVICE_PREPARE_HARDWARE,
    PFN_WDF_DEVICE_RELEASE_HARDWARE, PFN_WDF_DRIVER_DEVICE_ADD, PFN_WDF_FILE_CLEANUP,
    PFN_WDF_IO_QUEUE_IO_DEVICE_CONTROL, ULONG, WDF_DRIVER_CONFIG, WDF_EXECUTION_LEVEL,
    WDF_FILEOBJECT_CLASS, WDF_FILEOBJECT_CONFIG, WDF_IO_QUEUE_CONFIG, WDF_OBJECT_ATTRIBUTES,
    WDF_PNPPOWER_EVENT_CALLBACKS, WDF_SYNCHRONIZATION_SCOPE, WDF_TRI_STATE,
};
